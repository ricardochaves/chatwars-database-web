...
import { Button, Col, Input, InputGroup, InputGroupAddon, Row, Spinner, Table } from 'reactstrap';
        ...
        if (error) {
            ...
            return (
                <Row><Col>
                    <Row><Col>
                        <InputGroup>
                            <Input onChange={this.handleChange.bind(this)} value={this.state.searchItemName} placeholder="Item Name" />
                            <InputGroupAddon><Button onClick={this.handleClick} color="secondary">Search</Button></InputGroupAddon>
                        </InputGroup>
                    </Col></Row>
                    <Row><Col><Table hover size="sm">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Lot ID</th>
